...
trunk_dir = test_dir.parent


def trunk_relative_path(relative_path):
    return str((trunk_dir / relative_path).resolve())


def fixture_path(relative_path):
    return str((test_dir / "fixtures" / relative_path).resolve())


def example_path(relative_path):
    return str((trunk_dir / "examples" / relative_path).resolve())


trunk_path = str(trunk_dir)
if trunk_dir not in sys.path:
